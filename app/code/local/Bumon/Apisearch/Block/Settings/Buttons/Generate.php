<?php
class Bumon_Apisearch_Block_Settings_Buttons_Generate extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $url = Mage::helper("adminhtml")->getUrl('adminhtml/apifeed/generate', array('store' => $storeCode));
